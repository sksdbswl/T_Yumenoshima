...
E.g.
60.000.000 for 6000.0.0b11 => #if UNITY_VERSION >= 60000000
60.021.234 for 6000.2.1234f1 => #if UNITY_VERSION >= 60021234
However, note that at this time it is still clamped to 202329 for 2023.2.9 (as it has been throughout the 2023.3 beta).

#if UNITY_VERSION >= 60000000 (= 6.0)
#if UNITY_VERSION >= 60010000 (= 6.1)
...
Shader "Universal Render Pipeline/NiloToon/NiloToon_Character"
{
    Properties
    {
        ...
        [Tooltip(A larger bias will make 2D rim light occlude by nearby objects easier (removing more inner 2D rim light), great for producing a clean silhouette only rim light)]
        [Tooltip()]
        ...
        */
        ...
        [Sub(_BaseMapStackingLayer6Group)]_BaseMapStackingLayer6TexUVCenterPivotX("Center Pivot X", Float) = 0
        [Sub(_BaseMapStackingLayer6Group)]_BaseMapStackingLayer6TexUVCenterPivotY("Center Pivot Y", Float) = 0
        ...
        [Sub(_BaseMapStackingLayer6Group)]_BaseMapStackingLayer6TexUVOffsetX("UV Offset X", Float) = 0
        [Sub(_BaseMapStackingLayer6Group)]_BaseMapStackingLayer6TexUVOffsetY("UV Offset Y", Float) = 0
        ...
        [Tooltip(.    texture uv animation loop effect)]
        [Tooltip(.    (Any effect that is suitable))]
        [Main(_BaseMapStackingLayer11Group, _BASEMAP_STACKING_LAYER11)]_BaseMapStackingLayer11Enable("Base Map Stacking Layer 11", Float) = 0
        
        [Helpbox(Layer Map Wrap mode is repeat clamp (not texture import settings).)]
                
        [Title(_BaseMapStackingLayer11Group, Master Control)]
        [Sub(_BaseMapStackingLayer11Group)]_BaseMapStackingLayer11MasterStrength("Strength", Range(0,1)) = 1

        [Title(_BaseMapStackingLayer11Group, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayer11Group, Blending Mode)]
        [Tooltip(Same as the blending mode in Photoshop.)]
        [Tooltip(Decide how this layer should combine with Base Map.)]
        [Tooltip(.     Normal RGBA, same as the normal blending layer in Photoshop, will modify the alpha of Base Map also.)]
        [Tooltip(.     Normal RGB, replace the RGB of Base Map, will not modify the alpha of the Base Map.)]
        ...
        [Tooltip(.     Screen RGB, soft additive with the RGB color of Base Map. Only works if the blending colors are both within LDR 0 to 1 range.)]
        [Tooltip(.     Multiply RGB, multiply with the RGB color of Base Map.)]
        [SubEnum(_BaseMapStackingLayer11Group,Normal RGBA,0,Normal RGB,1,Add RGB,2,Screen RGB,3,Multiply RGB,4,None,5)]_BaseMapStackingLayer11ColorBlendMode("Blending Mode", Float) = 0
        
        [Title(_BaseMapStackingLayer11Group, ........................................................................................................................................................................................................................................................................................................................................................................)]
        
        [Title(_BaseMapStackingLayer11Group, Layer Content)]
        [Tooltip(A map that contains the content of this layer, same as the content of a Photoshop layer.)]
        [Tex(_BaseMapStackingLayer11Group,_BaseMapStackingLayer11TintColor)][NoScaleOffset]_BaseMapStackingLayer11Tex("Layer Map", 2D) = "white" {}
        [HideInInspector][HDR]_BaseMapStackingLayer11TintColor("", Color) = (1,1,1,1)
        [Tooltip(Which UV channel should be used for sampling Layer Map.)]
        [SubEnum(_BaseMapStackingLayer11Group,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayer11TexUVIndex("               UV Mode", Float) = 0
        [Tooltip(Enable to ignore the alpha channel of Layer Map. (Treat the alpha channel of Layer Map as 1))]
        [SubToggle(_BaseMapStackingLayer11Group, _)]_BaseMapStackingLayer11TexIgnoreAlpha("               Ignore Map Alpha?", Float) = 0
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayer11Group, Scale(xy) Pos(zw))]
        [Tooltip((x,y) controls the perceptual Scale of texture sampled.)]
        [Tooltip((z,w) controls the perceptual Position of texture sampled.)]
        [Sub(_BaseMapStackingLayer11Group)]_BaseMapStackingLayer11TexUVCenterPivotScalePos("", Vector) = (1,1,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayer11Group, Tiling(xy) Offset(zw))]
        [Tooltip((x,y) controls the classic UV Tiling of Layer Map.)]
        [Tooltip((z,w) controls the classic UV Offset of Layer Map.)]
        [Sub(_BaseMapStackingLayer11Group)]_BaseMapStackingLayer11TexUVScaleOffset("", Vector) = (1,1,0,0)

        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayer11Group, Scroll Speed(xy))]
        [Tooltip((x,y) controls the UV scrolling speed of Layer Map, similar to a river panning texture.)]
        [Tooltip((z,w) unused.)]
        [Sub(_BaseMapStackingLayer11Group)]_BaseMapStackingLayer11TexUVAnimSpeed("", Vector) = (0,0,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayer11Group, Rotation in Degree)]
        [Tooltip(Controls the fixed angle rotation, good for static logos or decals.)]
        [Sub(_BaseMapStackingLayer11Group)]_BaseMapStackingLayer11TexUVRotatedAngle("Angle", Float) = 0
        [Advanced(UV Edit)]
        [Tooltip(Controls the animation angle rotation per second, similar to a rotating fan.)]
        [Sub(_BaseMapStackingLayer11Group)]_BaseMapStackingLayer11TexUVRotateSpeed("Speed", Float) = 0
        
        [Title(_BaseMapStackingLayer11Group, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayer11Group, Mask)]
        [Tooltip(Controls which area this layer is allowed to show, similar to the layer mask of a Photoshop layer.)]
        [Tooltip(.    White is show)]
        [Tooltip(.    Gray is show(with 50 percent alpha))]
        [Tooltip(.    Black is hide)]
        [Tex(_BaseMapStackingLayer11Group,_BaseMapStackingLayer11MaskTexChannel)][NoScaleOffset]_BaseMapStackingLayer11MaskTex("Mask Map", 2D) = "white" {}
        [HideInInspector]_BaseMapStackingLayer11MaskTexChannel("", Vector) = (0,1,0,0) // use G as default value because if input is rgb grayscale texture, g is 1 bit better
        [SubEnum(_BaseMapStackingLayer11Group,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayer11MaskUVIndex("               UV Mode", Float) = 0
        
        [SubToggle(_BaseMapStackingLayer11Group, _)]_BaseMapStackingLayer11MaskTexAsIDMap("               Extract from ID?", Float) = 0
        [ShowIf(_BaseMapStackingLayer11MaskTexAsIDMap, Equal, 1)]
        [SubIntRange(_BaseMapStackingLayer11Group)]_BaseMapStackingLayer11MaskTexExtractFromID("                   ID", Range(0,255)) = 255 // default white = pass
        
        [Tooltip(Enable to invert the value of Mask Map.)]
        [SubToggle(_BaseMapStackingLayer11Group, _)]_BaseMapStackingLayer11MaskInvertColor("               Invert?", Float) = 0

        [MinMaxSlider(_BaseMapStackingLayer11Group,_BaseMapStackingLayer11MaskRemapStart,_BaseMapStackingLayer11MaskRemapEnd)]_BaseMapStackingLayer11MaskRemapMinMaxSlider("               Remap", Range(0.0,1.0)) = 1.0
        [HideInInspector]_BaseMapStackingLayer11MaskRemapStart("", Range(0.0,1.0)) = 0.0
        [HideInInspector]_BaseMapStackingLayer11MaskRemapEnd("", Range(0.0,1.0)) = 1.0
        
        [Title(_BaseMapStackingLayer11Group, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayer11Group, Front and Back Face)]
        [Tooltip(Select the render faces that you want to show this layer.)]
        [SubEnum(_BaseMapStackingLayer11Group,Both,0,Front,2,Back,1)]_BaseMapStackingLayer11ApplytoFaces("Show in which faces?", Float) = 0
        
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Base Map Stacking Layer SkinColor
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [ShowIf(_UIDisplayMode, GEqual, 200)]
        [Tooltip(Just like adding a Photoshop layer on top of Base Map.)]
        [Tooltip(Useful if you need to overlay a texture on top of Base Map. For example, if you want to add)]
        ...
        [Tooltip(.    texture uv animation loop effect)]
        [Tooltip(.    (Any effect that is suitable))]
        [Main(_BaseMapStackingLayerSkinColorGroup, _BASEMAP_STACKING_LAYER_SKINCOLOR)]_BaseMapStackingLayerSkinColorEnable("Base Map Stacking Layer SkinColor", Float) = 0
        
        [Helpbox(Layer Map Wrap mode is repeat clamp (not texture import settings).)]
                
        [Title(_BaseMapStackingLayerSkinColorGroup, Master Control)]
        [Sub(_BaseMapStackingLayerSkinColorGroup)]_BaseMapStackingLayerSkinColorMasterStrength("Strength", Range(0,1)) = 1

        [Title(_BaseMapStackingLayerSkinColorGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerSkinColorGroup, Blending Mode)]
        [Tooltip(Same as the blending mode in Photoshop.)]
        [Tooltip(Decide how this layer should combine with Base Map.)]
        [Tooltip(.     Normal RGBA, same as the normal blending layer in Photoshop, will modify the alpha of Base Map also.)]
        [Tooltip(.     Normal RGB, replace the RGB of Base Map, will not modify the alpha of the Base Map.)]
        ...
        [Tooltip(.     Screen RGB, soft additive with the RGB color of Base Map. Only works if the blending colors are both within LDR 0 to 1 range.)]
        [Tooltip(.     Multiply RGB, multiply with the RGB color of Base Map.)]
        [SubEnum(_BaseMapStackingLayerSkinColorGroup,Normal RGBA,0,Normal RGB,1,Add RGB,2,Screen RGB,3,Multiply RGB,4,None,5)]_BaseMapStackingLayerSkinColorColorBlendMode("Blending Mode", Float) = 0
        
        [Title(_BaseMapStackingLayerSkinColorGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]
        
        [Title(_BaseMapStackingLayerSkinColorGroup, Layer Content)]
        [Tooltip(A map that contains the content of this layer, same as the content of a Photoshop layer.)]
        [Tex(_BaseMapStackingLayerSkinColorGroup,_BaseMapStackingLayerSkinColorTintColor)][NoScaleOffset]_BaseMapStackingLayerSkinColorTex("Layer Map", 2D) = "white" {}
        [HideInInspector][HDR]_BaseMapStackingLayerSkinColorTintColor("", Color) = (1,1,1,1)
        [Tooltip(Which UV channel should be used for sampling Layer Map.)]
        [SubEnum(_BaseMapStackingLayerSkinColorGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerSkinColorTexUVIndex("               UV Mode", Float) = 0
        [Tooltip(Enable to ignore the alpha channel of Layer Map. (Treat the alpha channel of Layer Map as 1))]
        [SubToggle(_BaseMapStackingLayerSkinColorGroup, _)]_BaseMapStackingLayerSkinColorTexIgnoreAlpha("               Ignore Map Alpha?", Float) = 0
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerSkinColorGroup, Scale(xy) Pos(zw))]
        [Tooltip((x,y) controls the perceptual Scale of texture sampled.)]
        [Tooltip((z,w) controls the perceptual Position of texture sampled.)]
        [Sub(_BaseMapStackingLayerSkinColorGroup)]_BaseMapStackingLayerSkinColorTexUVCenterPivotScalePos("", Vector) = (1,1,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerSkinColorGroup, Tiling(xy) Offset(zw))]
        [Tooltip((x,y) controls the classic UV Tiling of Layer Map.)]
        [Tooltip((z,w) controls the classic UV Offset of Layer Map.)]
        [Sub(_BaseMapStackingLayerSkinColorGroup)]_BaseMapStackingLayerSkinColorTexUVScaleOffset("", Vector) = (1,1,0,0)

        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerSkinColorGroup, Scroll Speed(xy))]
        [Tooltip((x,y) controls the UV scrolling speed of Layer Map, similar to a river panning texture.)]
        [Tooltip((z,w) unused.)]
        [Sub(_BaseMapStackingLayerSkinColorGroup)]_BaseMapStackingLayerSkinColorTexUVAnimSpeed("", Vector) = (0,0,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerSkinColorGroup, Rotation in Degree)]
        [Tooltip(Controls the fixed angle rotation, good for static logos or decals.)]
        [Sub(_BaseMapStackingLayerSkinColorGroup)]_BaseMapStackingLayerSkinColorTexUVRotatedAngle("Angle", Float) = 0
        [Advanced(UV Edit)]
        [Tooltip(Controls the animation angle rotation per second, similar to a rotating fan.)]
        [Sub(_BaseMapStackingLayerSkinColorGroup)]_BaseMapStackingLayerSkinColorTexUVRotateSpeed("Speed", Float) = 0
        
        [Title(_BaseMapStackingLayerSkinColorGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerSkinColorGroup, Mask)]
        [Tooltip(Controls which area this layer is allowed to show, similar to the layer mask of a Photoshop layer.)]
        [Tooltip(.    White is show)]
        [Tooltip(.    Gray is show(with 50 percent alpha))]
        [Tooltip(.    Black is hide)]
        [Tex(_BaseMapStackingLayerSkinColorGroup,_BaseMapStackingLayerSkinColorMaskTexChannel)][NoScaleOffset]_BaseMapStackingLayerSkinColorMaskTex("Mask Map", 2D) = "white" {}
        [HideInInspector]_BaseMapStackingLayerSkinColorMaskTexChannel("", Vector) = (0,1,0,0) // use G as default value because if input is rgb grayscale texture, g is 1 bit better
        [SubEnum(_BaseMapStackingLayerSkinColorGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerSkinColorMaskUVIndex("               UV Mode", Float) = 0
        
        [SubToggle(_BaseMapStackingLayerSkinColorGroup, _)]_BaseMapStackingLayerSkinColorMaskTexAsIDMap("               Extract from ID?", Float) = 0
        [ShowIf(_BaseMapStackingLayerSkinColorMaskTexAsIDMap, Equal, 1)]
        [SubIntRange(_BaseMapStackingLayerSkinColorGroup)]_BaseMapStackingLayerSkinColorMaskTexExtractFromID("                   ID", Range(0,255)) = 255 // default white = pass
        
        [Tooltip(Enable to invert the value of Mask Map.)]
        [SubToggle(_BaseMapStackingLayerSkinColorGroup, _)]_BaseMapStackingLayerSkinColorMaskInvertColor("               Invert?", Float) = 0

        [MinMaxSlider(_BaseMapStackingLayerSkinColorGroup,_BaseMapStackingLayerSkinColorMaskRemapStart,_BaseMapStackingLayerSkinColorMaskRemapEnd)]_BaseMapStackingLayerSkinColorMaskRemapMinMaxSlider("               Remap", Range(0.0,1.0)) = 1.0
        [HideInInspector]_BaseMapStackingLayerSkinColorMaskRemapStart("", Range(0.0,1.0)) = 0.0
        [HideInInspector]_BaseMapStackingLayerSkinColorMaskRemapEnd("", Range(0.0,1.0)) = 1.0
        
        [Title(_BaseMapStackingLayerSkinColorGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerSkinColorGroup, Front and Back Face)]
        [Tooltip(Select the render faces that you want to show this layer.)]
        [SubEnum(_BaseMapStackingLayerSkinColorGroup,Both,0,Front,2,Back,1)]_BaseMapStackingLayerSkinColorApplytoFaces("Show in which faces?", Float) = 0
        
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Base Map Stacking Layer Eye Makeup
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [ShowIf(_UIDisplayMode, GEqual, 200)]
        [Tooltip(Just like adding a Photoshop layer on top of Base Map.)]
        [Tooltip(Useful if you need to overlay a texture on top of Base Map. For example, if you want to add)]
        ...
        [Tooltip(.    texture uv animation loop effect)]
        [Tooltip(.    (Any effect that is suitable))]
        [Main(_BaseMapStackingLayerEyeMakeupGroup, _BASEMAP_STACKING_LAYER_EYEMAKEUP)]_BaseMapStackingLayerEyeMakeupEnable("Base Map Stacking Layer Eye MakeUp", Float) = 0
        
        [Helpbox(Layer Map Wrap mode is repeat clamp (not texture import settings).)]
                
        [Title(_BaseMapStackingLayerEyeMakeupGroup, Master Control)]
        [Sub(_BaseMapStackingLayerEyeMakeupGroup)]_BaseMapStackingLayerEyeMakeupMasterStrength("Strength", Range(0,1)) = 1

        [Title(_BaseMapStackingLayerEyeMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerEyeMakeupGroup, Blending Mode)]
        [Tooltip(Same as the blending mode in Photoshop.)]
        [Tooltip(Decide how this layer should combine with Base Map.)]
        [Tooltip(.     Normal RGBA, same as the normal blending layer in Photoshop, will modify the alpha of Base Map also.)]
        [Tooltip(.     Normal RGB, replace the RGB of Base Map, will not modify the alpha of the Base Map.)]
        ...
        [Tooltip(.     Screen RGB, soft additive with the RGB color of Base Map. Only works if the blending colors are both within LDR 0 to 1 range.)]
        [Tooltip(.     Multiply RGB, multiply with the RGB color of Base Map.)]
        [SubEnum(_BaseMapStackingLayerEyeMakeupGroup,Normal RGBA,0,Normal RGB,1,Add RGB,2,Screen RGB,3,Multiply RGB,4,None,5)]_BaseMapStackingLayerEyeMakeupColorBlendMode("Blending Mode", Float) = 0
        
        [Title(_BaseMapStackingLayerEyeMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]
        
        [Title(_BaseMapStackingLayerEyeMakeupGroup, Layer Content)]
        [Tooltip(A map that contains the content of this layer, same as the content of a Photoshop layer.)]
        [Tex(_BaseMapStackingLayerEyeMakeupGroup,_BaseMapStackingLayerEyeMakeupTintColor)][NoScaleOffset]_BaseMapStackingLayerEyeMakeupTex("Layer Map", 2D) = "white" {}
        [HideInInspector][HDR]_BaseMapStackingLayerEyeMakeupTintColor("", Color) = (1,1,1,1)
        [Tooltip(Which UV channel should be used for sampling Layer Map.)]
        [SubEnum(_BaseMapStackingLayerEyeMakeupGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerEyeMakeupTexUVIndex("               UV Mode", Float) = 0
        [Tooltip(Enable to ignore the alpha channel of Layer Map. (Treat the alpha channel of Layer Map as 1))]
        [SubToggle(_BaseMapStackingLayerEyeMakeupGroup, _)]_BaseMapStackingLayerEyeMakeupTexIgnoreAlpha("               Ignore Map Alpha?", Float) = 0
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerEyeMakeupGroup, Scale(xy) Pos(zw))]
        [Tooltip((x,y) controls the perceptual Scale of texture sampled.)]
        [Tooltip((z,w) controls the perceptual Position of texture sampled.)]
        [Sub(_BaseMapStackingLayerEyeMakeupGroup)]_BaseMapStackingLayerEyeMakeupTexUVCenterPivotScalePos("", Vector) = (1,1,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerEyeMakeupGroup, Tiling(xy) Offset(zw))]
        [Tooltip((x,y) controls the classic UV Tiling of Layer Map.)]
        [Tooltip((z,w) controls the classic UV Offset of Layer Map.)]
        [Sub(_BaseMapStackingLayerEyeMakeupGroup)]_BaseMapStackingLayerEyeMakeupTexUVScaleOffset("", Vector) = (1,1,0,0)

        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerEyeMakeupGroup, Scroll Speed(xy))]
        [Tooltip((x,y) controls the UV scrolling speed of Layer Map, similar to a river panning texture.)]
        [Tooltip((z,w) unused.)]
        [Sub(_BaseMapStackingLayerEyeMakeupGroup)]_BaseMapStackingLayerEyeMakeupTexUVAnimSpeed("", Vector) = (0,0,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerEyeMakeupGroup, Rotation in Degree)]
        [Tooltip(Controls the fixed angle rotation, good for static logos or decals.)]
        [Sub(_BaseMapStackingLayerEyeMakeupGroup)]_BaseMapStackingLayerEyeMakeupTexUVRotatedAngle("Angle", Float) = 0
        [Advanced(UV Edit)]
        [Tooltip(Controls the animation angle rotation per second, similar to a rotating fan.)]
        [Sub(_BaseMapStackingLayerEyeMakeupGroup)]_BaseMapStackingLayerEyeMakeupTexUVRotateSpeed("Speed", Float) = 0
        
        [Title(_BaseMapStackingLayerEyeMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerEyeMakeupGroup, Mask)]
        [Tooltip(Controls which area this layer is allowed to show, similar to the layer mask of a Photoshop layer.)]
        [Tooltip(.    White is show)]
        [Tooltip(.    Gray is show(with 50 percent alpha))]
        [Tooltip(.    Black is hide)]
        [Tex(_BaseMapStackingLayerEyeMakeupGroup,_BaseMapStackingLayerEyeMakeupMaskTexChannel)][NoScaleOffset]_BaseMapStackingLayerEyeMakeupMaskTex("Mask Map", 2D) = "white" {}
        [HideInInspector]_BaseMapStackingLayerEyeMakeupMaskTexChannel("", Vector) = (0,1,0,0) // use G as default value because if input is rgb grayscale texture, g is 1 bit better
        [SubEnum(_BaseMapStackingLayerEyeMakeupGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerEyeMakeupMaskUVIndex("               UV Mode", Float) = 0
        
        [SubToggle(_BaseMapStackingLayerEyeMakeupGroup, _)]_BaseMapStackingLayerEyeMakeupMaskTexAsIDMap("               Extract from ID?", Float) = 0
        [ShowIf(_BaseMapStackingLayerEyeMakeupMaskTexAsIDMap, Equal, 1)]
        [SubIntRange(_BaseMapStackingLayerEyeMakeupGroup)]_BaseMapStackingLayerEyeMakeupMaskTexExtractFromID("                   ID", Range(0,255)) = 255 // default white = pass
        
        [Tooltip(Enable to invert the value of Mask Map.)]
        [SubToggle(_BaseMapStackingLayerEyeMakeupGroup, _)]_BaseMapStackingLayerEyeMakeupMaskInvertColor("               Invert?", Float) = 0

        [MinMaxSlider(_BaseMapStackingLayerEyeMakeupGroup,_BaseMapStackingLayerEyeMakeupMaskRemapStart,_BaseMapStackingLayerEyeMakeupMaskRemapEnd)]_BaseMapStackingLayerEyeMakeupMaskRemapMinMaxSlider("               Remap", Range(0.0,1.0)) = 1.0
        [HideInInspector]_BaseMapStackingLayerEyeMakeupMaskRemapStart("", Range(0.0,1.0)) = 0.0
        [HideInInspector]_BaseMapStackingLayerEyeMakeupMaskRemapEnd("", Range(0.0,1.0)) = 1.0
        
        [Title(_BaseMapStackingLayerEyeMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerEyeMakeupGroup, Front and Back Face)]
        [Tooltip(Select the render faces that you want to show this layer.)]
        [SubEnum(_BaseMapStackingLayerEyeMakeupGroup,Both,0,Front,2,Back,1)]_BaseMapStackingLayerEyeMakeupApplytoFaces("Show in which faces?", Float) = 0
        
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Base Map Stacking Layer CheekMakeup
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [ShowIf(_UIDisplayMode, GEqual, 200)]
        [Tooltip(Just like adding a Photoshop layer on top of Base Map.)]
        [Tooltip(Useful if you need to overlay a texture on top of Base Map. For example, if you want to add)]
        ...
        [Tooltip(.    texture uv animation loop effect)]
        [Tooltip(.    (Any effect that is suitable))]
        [Main(_BaseMapStackingLayerCheekMakeupGroup, _BASEMAP_STACKING_LAYER_CHEEKMAKEUP)]_BaseMapStackingLayerCheekMakeupEnable("Base Map Stacking Layer Cheek MakeUp", Float) = 0
        
        [Helpbox(Layer Map Wrap mode is repeat clamp (not texture import settings).)]
                
        [Title(_BaseMapStackingLayerCheekMakeupGroup, Master Control)]
        [Sub(_BaseMapStackingLayerCheekMakeupGroup)]_BaseMapStackingLayerCheekMakeupMasterStrength("Strength", Range(0,1)) = 1

        [Title(_BaseMapStackingLayerCheekMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerCheekMakeupGroup, Blending Mode)]
        [Tooltip(Same as the blending mode in Photoshop.)]
        [Tooltip(Decide how this layer should combine with Base Map.)]
        [Tooltip(.     Normal RGBA, same as the normal blending layer in Photoshop, will modify the alpha of Base Map also.)]
        [Tooltip(.     Normal RGB, replace the RGB of Base Map, will not modify the alpha of the Base Map.)]
        ...
        [Tooltip(.     Screen RGB, soft additive with the RGB color of Base Map. Only works if the blending colors are both within LDR 0 to 1 range.)]
        [Tooltip(.     Multiply RGB, multiply with the RGB color of Base Map.)]
        [SubEnum(_BaseMapStackingLayerCheekMakeupGroup,Normal RGBA,0,Normal RGB,1,Add RGB,2,Screen RGB,3,Multiply RGB,4,None,5)]_BaseMapStackingLayerCheekMakeupColorBlendMode("Blending Mode", Float) = 0
        
        [Title(_BaseMapStackingLayerCheekMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]
        
        [Title(_BaseMapStackingLayerCheekMakeupGroup, Layer Content)]
        [Tooltip(A map that contains the content of this layer, same as the content of a Photoshop layer.)]
        [Tex(_BaseMapStackingLayerCheekMakeupGroup,_BaseMapStackingLayerCheekMakeupTintColor)][NoScaleOffset]_BaseMapStackingLayerCheekMakeupTex("Layer Map", 2D) = "white" {}
        [HideInInspector][HDR]_BaseMapStackingLayerCheekMakeupTintColor("", Color) = (1,1,1,1)
        [Tooltip(Which UV channel should be used for sampling Layer Map.)]
        [SubEnum(_BaseMapStackingLayerCheekMakeupGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerCheekMakeupTexUVIndex("               UV Mode", Float) = 0
        [Tooltip(Enable to ignore the alpha channel of Layer Map. (Treat the alpha channel of Layer Map as 1))]
        [SubToggle(_BaseMapStackingLayerCheekMakeupGroup, _)]_BaseMapStackingLayerCheekMakeupTexIgnoreAlpha("               Ignore Map Alpha?", Float) = 0
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerCheekMakeupGroup, Scale(xy) Pos(zw))]
        [Tooltip((x,y) controls the perceptual Scale of texture sampled.)]
        [Tooltip((z,w) controls the perceptual Position of texture sampled.)]
        [Sub(_BaseMapStackingLayerCheekMakeupGroup)]_BaseMapStackingLayerCheekMakeupTexUVCenterPivotScalePos("", Vector) = (1,1,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerCheekMakeupGroup, Tiling(xy) Offset(zw))]
        [Tooltip((x,y) controls the classic UV Tiling of Layer Map.)]
        [Tooltip((z,w) controls the classic UV Offset of Layer Map.)]
        [Sub(_BaseMapStackingLayerCheekMakeupGroup)]_BaseMapStackingLayerCheekMakeupTexUVScaleOffset("", Vector) = (1,1,0,0)

        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerCheekMakeupGroup, Scroll Speed(xy))]
        [Tooltip((x,y) controls the UV scrolling speed of Layer Map, similar to a river panning texture.)]
        [Tooltip((z,w) unused.)]
        [Sub(_BaseMapStackingLayerCheekMakeupGroup)]_BaseMapStackingLayerCheekMakeupTexUVAnimSpeed("", Vector) = (0,0,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerCheekMakeupGroup, Rotation in Degree)]
        [Tooltip(Controls the fixed angle rotation, good for static logos or decals.)]
        [Sub(_BaseMapStackingLayerCheekMakeupGroup)]_BaseMapStackingLayerCheekMakeupTexUVRotatedAngle("Angle", Float) = 0
        [Advanced(UV Edit)]
        [Tooltip(Controls the animation angle rotation per second, similar to a rotating fan.)]
        [Sub(_BaseMapStackingLayerCheekMakeupGroup)]_BaseMapStackingLayerCheekMakeupTexUVRotateSpeed("Speed", Float) = 0
        
        [Title(_BaseMapStackingLayerCheekMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerCheekMakeupGroup, Mask)]
        [Tooltip(Controls which area this layer is allowed to show, similar to the layer mask of a Photoshop layer.)]
        [Tooltip(.    White is show)]
        [Tooltip(.    Gray is show(with 50 percent alpha))]
        [Tooltip(.    Black is hide)]
        [Tex(_BaseMapStackingLayerCheekMakeupGroup,_BaseMapStackingLayerCheekMakeupMaskTexChannel)][NoScaleOffset]_BaseMapStackingLayerCheekMakeupMaskTex("Mask Map", 2D) = "white" {}
        [HideInInspector]_BaseMapStackingLayerCheekMakeupMaskTexChannel("", Vector) = (0,1,0,0) // use G as default value because if input is rgb grayscale texture, g is 1 bit better
        [SubEnum(_BaseMapStackingLayerCheekMakeupGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerCheekMakeupMaskUVIndex("               UV Mode", Float) = 0
        
        [SubToggle(_BaseMapStackingLayerCheekMakeupGroup, _)]_BaseMapStackingLayerCheekMakeupMaskTexAsIDMap("               Extract from ID?", Float) = 0
        [ShowIf(_BaseMapStackingLayerCheekMakeupMaskTexAsIDMap, Equal, 1)]
        [SubIntRange(_BaseMapStackingLayerCheekMakeupGroup)]_BaseMapStackingLayerCheekMakeupMaskTexExtractFromID("                   ID", Range(0,255)) = 255 // default white = pass
        
        [Tooltip(Enable to invert the value of Mask Map.)]
        [SubToggle(_BaseMapStackingLayerCheekMakeupGroup, _)]_BaseMapStackingLayerCheekMakeupMaskInvertColor("               Invert?", Float) = 0

        [MinMaxSlider(_BaseMapStackingLayerCheekMakeupGroup,_BaseMapStackingLayerCheekMakeupMaskRemapStart,_BaseMapStackingLayerCheekMakeupMaskRemapEnd)]_BaseMapStackingLayerCheekMakeupMaskRemapMinMaxSlider("               Remap", Range(0.0,1.0)) = 1.0
        [HideInInspector]_BaseMapStackingLayerCheekMakeupMaskRemapStart("", Range(0.0,1.0)) = 0.0
        [HideInInspector]_BaseMapStackingLayerCheekMakeupMaskRemapEnd("", Range(0.0,1.0)) = 1.0
        
        [Title(_BaseMapStackingLayerCheekMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerCheekMakeupGroup, Front and Back Face)]
        [Tooltip(Select the render faces that you want to show this layer.)]
        [SubEnum(_BaseMapStackingLayerCheekMakeupGroup,Both,0,Front,2,Back,1)]_BaseMapStackingLayerCheekMakeupApplytoFaces("Show in which faces?", Float) = 0
        
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Base Map Stacking Layer LipMakeup
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [ShowIf(_UIDisplayMode, GEqual, 200)]
        [Tooltip(Just like adding a Photoshop layer on top of Base Map.)]
        [Tooltip(Useful if you need to overlay a texture on top of Base Map. For example, if you want to add)]
        ...
        [Tooltip(.    texture uv animation loop effect)]
        [Tooltip(.    (Any effect that is suitable))]
        [Main(_BaseMapStackingLayerLipMakeupGroup, _BASEMAP_STACKING_LAYER_LIPMAKEUP)]_BaseMapStackingLayerLipMakeupEnable("Base Map Stacking Layer Lip MakeUp", Float) = 0
        
        [Helpbox(Layer Map Wrap mode is repeat clamp (not texture import settings).)]
                
        [Title(_BaseMapStackingLayerLipMakeupGroup, Master Control)]
        [Sub(_BaseMapStackingLayerLipMakeupGroup)]_BaseMapStackingLayerLipMakeupMasterStrength("Strength", Range(0,1)) = 1

        [Title(_BaseMapStackingLayerLipMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerLipMakeupGroup, Blending Mode)]
        [Tooltip(Same as the blending mode in Photoshop.)]
        [Tooltip(Decide how this layer should combine with Base Map.)]
        [Tooltip(.     Normal RGBA, same as the normal blending layer in Photoshop, will modify the alpha of Base Map also.)]
        [Tooltip(.     Normal RGB, replace the RGB of Base Map, will not modify the alpha of the Base Map.)]
        ...
        [Tooltip(.     Screen RGB, soft additive with the RGB color of Base Map. Only works if the blending colors are both within LDR 0 to 1 range.)]
        [Tooltip(.     Multiply RGB, multiply with the RGB color of Base Map.)]
        [SubEnum(_BaseMapStackingLayerLipMakeupGroup,Normal RGBA,0,Normal RGB,1,Add RGB,2,Screen RGB,3,Multiply RGB,4,None,5)]_BaseMapStackingLayerLipMakeupColorBlendMode("Blending Mode", Float) = 0
        
        [Title(_BaseMapStackingLayerLipMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]
        
        [Title(_BaseMapStackingLayerLipMakeupGroup, Layer Content)]
        [Tooltip(A map that contains the content of this layer, same as the content of a Photoshop layer.)]
        [Tex(_BaseMapStackingLayerLipMakeupGroup,_BaseMapStackingLayerLipMakeupTintColor)][NoScaleOffset]_BaseMapStackingLayerLipMakeupTex("Layer Map", 2D) = "white" {}
        [HideInInspector][HDR]_BaseMapStackingLayerLipMakeupTintColor("", Color) = (1,1,1,1)
        [Tooltip(Which UV channel should be used for sampling Layer Map.)]
        [SubEnum(_BaseMapStackingLayerLipMakeupGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerLipMakeupTexUVIndex("               UV Mode", Float) = 0
        [Tooltip(Enable to ignore the alpha channel of Layer Map. (Treat the alpha channel of Layer Map as 1))]
        [SubToggle(_BaseMapStackingLayerLipMakeupGroup, _)]_BaseMapStackingLayerLipMakeupTexIgnoreAlpha("               Ignore Map Alpha?", Float) = 0
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerLipMakeupGroup, Scale(xy) Pos(zw))]
        [Tooltip((x,y) controls the perceptual Scale of texture sampled.)]
        [Tooltip((z,w) controls the perceptual Position of texture sampled.)]
        [Sub(_BaseMapStackingLayerLipMakeupGroup)]_BaseMapStackingLayerLipMakeupTexUVCenterPivotScalePos("", Vector) = (1,1,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerLipMakeupGroup, Tiling(xy) Offset(zw))]
        [Tooltip((x,y) controls the classic UV Tiling of Layer Map.)]
        [Tooltip((z,w) controls the classic UV Offset of Layer Map.)]
        [Sub(_BaseMapStackingLayerLipMakeupGroup)]_BaseMapStackingLayerLipMakeupTexUVScaleOffset("", Vector) = (1,1,0,0)

        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerLipMakeupGroup, Scroll Speed(xy))]
        [Tooltip((x,y) controls the UV scrolling speed of Layer Map, similar to a river panning texture.)]
        [Tooltip((z,w) unused.)]
        [Sub(_BaseMapStackingLayerLipMakeupGroup)]_BaseMapStackingLayerLipMakeupTexUVAnimSpeed("", Vector) = (0,0,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerLipMakeupGroup, Rotation in Degree)]
        [Tooltip(Controls the fixed angle rotation, good for static logos or decals.)]
        [Sub(_BaseMapStackingLayerLipMakeupGroup)]_BaseMapStackingLayerLipMakeupTexUVRotatedAngle("Angle", Float) = 0
        [Advanced(UV Edit)]
        [Tooltip(Controls the animation angle rotation per second, similar to a rotating fan.)]
        [Sub(_BaseMapStackingLayerLipMakeupGroup)]_BaseMapStackingLayerLipMakeupTexUVRotateSpeed("Speed", Float) = 0
        
        [Title(_BaseMapStackingLayerLipMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerLipMakeupGroup, Mask)]
        [Tooltip(Controls which area this layer is allowed to show, similar to the layer mask of a Photoshop layer.)]
        [Tooltip(.    White is show)]
        [Tooltip(.    Gray is show(with 50 percent alpha))]
        [Tooltip(.    Black is hide)]
        [Tex(_BaseMapStackingLayerLipMakeupGroup,_BaseMapStackingLayerLipMakeupMaskTexChannel)][NoScaleOffset]_BaseMapStackingLayerLipMakeupMaskTex("Mask Map", 2D) = "white" {}
        [HideInInspector]_BaseMapStackingLayerLipMakeupMaskTexChannel("", Vector) = (0,1,0,0) // use G as default value because if input is rgb grayscale texture, g is 1 bit better
        [SubEnum(_BaseMapStackingLayerLipMakeupGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerLipMakeupMaskUVIndex("               UV Mode", Float) = 0
        
        [SubToggle(_BaseMapStackingLayerLipMakeupGroup, _)]_BaseMapStackingLayerLipMakeupMaskTexAsIDMap("               Extract from ID?", Float) = 0
        [ShowIf(_BaseMapStackingLayerLipMakeupMaskTexAsIDMap, Equal, 1)]
        [SubIntRange(_BaseMapStackingLayerLipMakeupGroup)]_BaseMapStackingLayerLipMakeupMaskTexExtractFromID("                   ID", Range(0,255)) = 255 // default white = pass
        
        [Tooltip(Enable to invert the value of Mask Map.)]
        [SubToggle(_BaseMapStackingLayerLipMakeupGroup, _)]_BaseMapStackingLayerLipMakeupMaskInvertColor("               Invert?", Float) = 0

        [MinMaxSlider(_BaseMapStackingLayerLipMakeupGroup,_BaseMapStackingLayerLipMakeupMaskRemapStart,_BaseMapStackingLayerLipMakeupMaskRemapEnd)]_BaseMapStackingLayerLipMakeupMaskRemapMinMaxSlider("               Remap", Range(0.0,1.0)) = 1.0
        [HideInInspector]_BaseMapStackingLayerLipMakeupMaskRemapStart("", Range(0.0,1.0)) = 0.0
        [HideInInspector]_BaseMapStackingLayerLipMakeupMaskRemapEnd("", Range(0.0,1.0)) = 1.0
        
        [Title(_BaseMapStackingLayerLipMakeupGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerLipMakeupGroup, Front and Back Face)]
        [Tooltip(Select the render faces that you want to show this layer.)]
        [SubEnum(_BaseMapStackingLayerLipMakeupGroup,Both,0,Front,2,Back,1)]_BaseMapStackingLayerLipMakeupApplytoFaces("Show in which faces?", Float) = 0
        
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Base Map Stacking Layer BeautySpot
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [ShowIf(_UIDisplayMode, GEqual, 200)]
        [Tooltip(Just like adding a Photoshop layer on top of Base Map.)]
        [Tooltip(Useful if you need to overlay a texture on top of Base Map. For example, if you want to add)]
        ...
        [Tooltip(.    texture uv animation loop effect)]
        [Tooltip(.    (Any effect that is suitable))]
        [Main(_BaseMapStackingLayerBeautySpotGroup, _BASEMAP_STACKING_LAYER_BEAUTYSPOT)]_BaseMapStackingLayerBeautySpotEnable("Base Map Stacking Layer Beauty Spot", Float) = 0
        
        [Helpbox(Layer Map Wrap mode is repeat clamp (not texture import settings).)]
                
        [Title(_BaseMapStackingLayerBeautySpotGroup, Master Control)]
        [Sub(_BaseMapStackingLayerBeautySpotGroup)]_BaseMapStackingLayerBeautySpotMasterStrength("Strength", Range(0,1)) = 1

        [Title(_BaseMapStackingLayerBeautySpotGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerBeautySpotGroup, Blending Mode)]
        [Tooltip(Same as the blending mode in Photoshop.)]
        [Tooltip(Decide how this layer should combine with Base Map.)]
        [Tooltip(.     Normal RGBA, same as the normal blending layer in Photoshop, will modify the alpha of Base Map also.)]
        [Tooltip(.     Normal RGB, replace the RGB of Base Map, will not modify the alpha of the Base Map.)]
        ...
        [Tooltip(.     Screen RGB, soft additive with the RGB color of Base Map. Only works if the blending colors are both within LDR 0 to 1 range.)]
        [Tooltip(.     Multiply RGB, multiply with the RGB color of Base Map.)]
        [SubEnum(_BaseMapStackingLayerBeautySpotGroup,Normal RGBA,0,Normal RGB,1,Add RGB,2,Screen RGB,3,Multiply RGB,4,None,5)]_BaseMapStackingLayerBeautySpotColorBlendMode("Blending Mode", Float) = 0
        
        [Title(_BaseMapStackingLayerBeautySpotGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]
        
        [Title(_BaseMapStackingLayerBeautySpotGroup, Layer Content)]
        [Tooltip(A map that contains the content of this layer, same as the content of a Photoshop layer.)]
        [Tex(_BaseMapStackingLayerBeautySpotGroup,_BaseMapStackingLayerBeautySpotTintColor)][NoScaleOffset]_BaseMapStackingLayerBeautySpotTex("Layer Map", 2D) = "white" {}
        [HideInInspector][HDR]_BaseMapStackingLayerBeautySpotTintColor("", Color) = (1,1,1,1)
        [Tooltip(Which UV channel should be used for sampling Layer Map.)]
        [SubEnum(_BaseMapStackingLayerBeautySpotGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerBeautySpotTexUVIndex("               UV Mode", Float) = 0
        [Tooltip(Enable to ignore the alpha channel of Layer Map. (Treat the alpha channel of Layer Map as 1))]
        [SubToggle(_BaseMapStackingLayerBeautySpotGroup, _)]_BaseMapStackingLayerBeautySpotTexIgnoreAlpha("               Ignore Map Alpha?", Float) = 0
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerBeautySpotGroup, Scale(xy) Pos(zw))]
        [Tooltip((x,y) controls the perceptual Scale of texture sampled.)]
        [Tooltip((z,w) controls the perceptual Position of texture sampled.)]
        [Sub(_BaseMapStackingLayerBeautySpotGroup)]_BaseMapStackingLayerBeautySpotTexUVCenterPivotScalePos("", Vector) = (1,1,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerBeautySpotGroup, Tiling(xy) Offset(zw))]
        [Tooltip((x,y) controls the classic UV Tiling of Layer Map.)]
        [Tooltip((z,w) controls the classic UV Offset of Layer Map.)]
        [Sub(_BaseMapStackingLayerBeautySpotGroup)]_BaseMapStackingLayerBeautySpotTexUVScaleOffset("", Vector) = (1,1,0,0)

        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerBeautySpotGroup, Scroll Speed(xy))]
        [Tooltip((x,y) controls the UV scrolling speed of Layer Map, similar to a river panning texture.)]
        [Tooltip((z,w) unused.)]
        [Sub(_BaseMapStackingLayerBeautySpotGroup)]_BaseMapStackingLayerBeautySpotTexUVAnimSpeed("", Vector) = (0,0,0,0)
        
        [Advanced(UV Edit)]
        [Title(_BaseMapStackingLayerBeautySpotGroup, Rotation in Degree)]
        [Tooltip(Controls the fixed angle rotation, good for static logos or decals.)]
        [Sub(_BaseMapStackingLayerBeautySpotGroup)]_BaseMapStackingLayerBeautySpotTexUVRotatedAngle("Angle", Float) = 0
        [Advanced(UV Edit)]
        [Tooltip(Controls the animation angle rotation per second, similar to a rotating fan.)]
        [Sub(_BaseMapStackingLayerBeautySpotGroup)]_BaseMapStackingLayerBeautySpotTexUVRotateSpeed("Speed", Float) = 0
        
        [Title(_BaseMapStackingLayerBeautySpotGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerBeautySpotGroup, Mask)]
        [Tooltip(Controls which area this layer is allowed to show, similar to the layer mask of a Photoshop layer.)]
        [Tooltip(.    White is show)]
        [Tooltip(.    Gray is show(with 50 percent alpha))]
        [Tooltip(.    Black is hide)]
        [Tex(_BaseMapStackingLayerBeautySpotGroup,_BaseMapStackingLayerBeautySpotMaskTexChannel)][NoScaleOffset]_BaseMapStackingLayerBeautySpotMaskTex("Mask Map", 2D) = "white" {}
        [HideInInspector]_BaseMapStackingLayerBeautySpotMaskTexChannel("", Vector) = (0,1,0,0) // use G as default value because if input is rgb grayscale texture, g is 1 bit better
        [SubEnum(_BaseMapStackingLayerBeautySpotGroup,UV0,0,UV1,1,UV2,2,UV3,3,MatCapUV,4,CharBoundUV,5,ScreenSpaceUV,6)]_BaseMapStackingLayerBeautySpotMaskUVIndex("               UV Mode", Float) = 0
        
        [SubToggle(_BaseMapStackingLayerBeautySpotGroup, _)]_BaseMapStackingLayerBeautySpotMaskTexAsIDMap("               Extract from ID?", Float) = 0
        [ShowIf(_BaseMapStackingLayerBeautySpotMaskTexAsIDMap, Equal, 1)]
        [SubIntRange(_BaseMapStackingLayerBeautySpotGroup)]_BaseMapStackingLayerBeautySpotMaskTexExtractFromID("                   ID", Range(0,255)) = 255 // default white = pass
        
        [Tooltip(Enable to invert the value of Mask Map.)]
        [SubToggle(_BaseMapStackingLayerBeautySpotGroup, _)]_BaseMapStackingLayerBeautySpotMaskInvertColor("               Invert?", Float) = 0

        [MinMaxSlider(_BaseMapStackingLayerBeautySpotGroup,_BaseMapStackingLayerBeautySpotMaskRemapStart,_BaseMapStackingLayerBeautySpotMaskRemapEnd)]_BaseMapStackingLayerBeautySpotMaskRemapMinMaxSlider("               Remap", Range(0.0,1.0)) = 1.0
        [HideInInspector]_BaseMapStackingLayerBeautySpotMaskRemapStart("", Range(0.0,1.0)) = 0.0
        [HideInInspector]_BaseMapStackingLayerBeautySpotMaskRemapEnd("", Range(0.0,1.0)) = 1.0
        
        [Title(_BaseMapStackingLayerBeautySpotGroup, ........................................................................................................................................................................................................................................................................................................................................................................)]

        [Title(_BaseMapStackingLayerBeautySpotGroup, Front and Back Face)]
        [Tooltip(Select the render faces that you want to show this layer.)]
        [SubEnum(_BaseMapStackingLayerBeautySpotGroup,Both,0,Front,2,Back,1)]_BaseMapStackingLayerBeautySpotApplytoFaces("Show in which faces?", Float) = 0
...
//        [Sub(_DynamicEyeGroup)]_DynamicEyeFinalTintColor("Final Tint Color", Color) = (1,1,1)
        ...
        [Title(_DynamicEyeGroup, Eye Iris)]
        [Tex(_DynamicEyeGroup)]_DynamicEyePupilMap("Iris Map", 2D) = "white" {}
        [Tex(_DynamicEyeGroup,_DynamicEyePupilMaskTexChannelMask)]_DynamicEyePupilMaskTex("Iris Mask Map", 2D) = "white" {}
        [HideInInspector]_DynamicEyePupilMaskTexChannelMask("Iris Mask Tex Channel Mask", Vector) = (0,0,0,1)
        
        [Tex(_DynamicEyeGroup)]_ParallaxEyeDepthTex("Parallax Eye DepthTex", 2D) = "white" {}
        [Tex(_DynamicEyeGroup)]_ParallaxEyeHighlightTex("Eye Highlight Tex", 2D) = "white" {}
        [Sub(_DynamicEyeGroup)]_EyeDepthViewDirAdjX ("Depth ViewDir Adjust x", Float) = 0
        [Sub(_DynamicEyeGroup)]_EyeDepthViewDirAdjY ("Depth ViewDir Adjust y", Float) = 0
       
        [Sub(_DynamicEyeGroup)]_EyeDepthScale  ("Eye Depth Scale",  Range(0,1))  = 1
        [Sub(_DynamicEyeGroup)]_EyeDepthNormal ("Eye Depth Normal", Range(-10,10)) = 1
        [Sub(_DynamicEyeGroup)]_EyeBrightness ("Iris Brightness", Range(-2,5)) = 1.5
        [Sub(_DynamicEyeGroup)]_EyeHighlightBrightness ("Highlight Brightness", Range(0,10)) = 1.5
        [Sub(_DynamicEyeGroup)]_EyeHighlightOffset ("Eye Highlight Offset", Vector) = (0,0,0,0)
        [Sub(_DynamicEyeGroup)]_EyeNoiseRange ("Eye Highlight Noise Range", Vector) = (0,0,0,0)
        [Sub(_DynamicEyeGroup)]_EyeShakeSpeed ("Eye Highlight Shake Speed", Float) = 2
...
//        [Sub(_DynamicEyeGroup)]_DynamicEyePupilMaskSoftness("Pupil Mask Softness", Range(0,1)) = 0.216
        ...
        [Title(_DynamicEyeGroup, User Customize Propertie)]
        [Tex(_DynamicEyeGroup)]_SecondDynamicEyePupilMap("Second Iris Map", 2D) = "white" {}
        [Sub(_DynamicEyeGroup)]_SecondDynamicEyePupilMapTintColor("Tint Color", Color) = (1,1,1)
        [Sub(_DynamicEyeGroup)]_EyeIrisBlend ("Iris Map Blend", Range(0,1)) = 0
        [Tex(_DynamicEyeGroup)]_ParallaxEyeHighlightTex02("Second Eye Highlight", 2D) = "black" {}
        [Sub(_DynamicEyeGroup)]_SecondEyeHighlightOffset ("Second Eye Highlight Offset", Vector) = (0,0,0,0)
        [Sub(_DynamicEyeGroup)]_EyeHighlightStrengthUserCustom ("Highlight Strength", Range(0,1)) = 1
        [Sub(_DynamicEyeGroup)]_EyeHighlightTintColor("Highlight Tint Color", Color) = (1,1,1)
...
//        [Tex(_DynamicEyeGroup)]_DynamicEyeWhiteMap("Eye White Map", 2D) = "white" {}
        ...
        [Sub(_KAJIYAKAY_SPECULAR)]_HairStrandSpecularShapeFrequency("Jitter", Range(0,10)) = 1
        ...
        [Sub(_KAJIYAKAY_SPECULAR)]_HairDirectionMap("Hairline Map", 2D) = "white" {}
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [Title(Per material effect options)]
        
        ...
        //[Helpbox((Very High performance cost when threshold is not 1))]
        
        [Title(Threshold)]
        [Sub(_PerMaterialDissolveGroup)]_PerMaterialDissolveCutoff("Threshold", Range(-1.0, 2.0)) = -1
        
        [Title(Dissolve Map)]
        [Preset(_PerMaterialDissolveGroup,NiloToonCharacter_PerMaterialDissolveThresholdMap_LWGUI_ShaderPropertyPreset)] _DissolveThresholdMapPreset ("Preset", float) = 0 
        [Tooltip(A map that contains the direction of dissolve using a grayscale gradient)]
        [Tex(_PerMaterialDissolveGroup)][NoScaleOffset]_PerMaterialDissolveThresholdMap("Map", 2D) = "linearGrey" {}
        [Sub(_PerMaterialDissolveGroup)]_PerMaterialDissolveThresholdMapUVTiling("            UV Tiling", Float) = 1
        [SubEnum(_PerMaterialDissolveGroup,UV0,0,UV1,1,UV2,2,UV3,3)]_PerMaterialDissolveThresholdMapUVIndex("            UV Index", Float) = 0
        [ChannelDrawer(_PerMaterialDissolveGroup)]_PerMaterialDissolveThresholdMapChannelMask("            Extract from", Vector) = (0,1,0,0)
        [SubToggle(_PerMaterialDissolveGroup, _)]_PerMaterialDissolveThresholdMapInvertColor("            Invert?", Float) = 0
        
        [Title(Pattern Map)]
        [Sub(_PerMaterialDissolveGroup)]_PerMaterialDissolvePatternMapStrength("Strength", Range(0.0, 1.0)) = 0.1
        
        [Preset(_PerMaterialDissolveGroup,NiloToonCharacter_PerMaterialDissolvePatternMap_LWGUI_ShaderPropertyPreset)] _DissolvePatternMapPreset ("Preset", float) = 0
        [Tooltip(A map that contains any loop pattern to add details to the dissolve effect)]
        [Tex(_PerMaterialDissolveGroup)][NoScaleOffset]_PerMaterialDissolvePatternMap("Map", 2D) = "linearGrey" {}
        [Sub(_PerMaterialDissolveGroup)]_PerMaterialDissolvePatternMapUVTiling("            UV Tiling", Float) = 1
        [SubEnum(_PerMaterialDissolveGroup,UV0,0,UV1,1,UV2,2,UV3,3)]_PerMaterialDissolvePatternMapUVIndex("            UV Index", Float) = 0
        [ChannelDrawer(_PerMaterialDissolveGroup)]_PerMaterialDissolvePatternMapChannelMask("            Extract from", Vector) = (1,0,0,0)
        [SubToggle(_PerMaterialDissolveGroup, _)]_PerMaterialDissolvePatternMapInvertColor("            Invert?", Float) = 0
        
        [Title(Edge Color)]
        [Sub(_PerMaterialDissolveGroup)]_PerMaterialDissolveEdgeWidth("Width", Range(0.0, 1.0)) = 0.05
        [HDR][Sub(_PerMaterialDissolveGroup)]_PerMaterialDissolveEdgeColor("Color",Color) = (16,8,0)
        ...
        // WIP
        /*
        [SubToggle(_PerCharacterEffectGroup,_NILOTOON_FORCE_MATERIAL_DISSOLVE)]_NiloToonForcePerCharDissolveOn("     Force on?", Float) = 0
        
        [SubToggle(_PerCharacterEffectGroup)]_ShouldMaterialOverrideDissolveAmount("Override Dissolve Amount?", Float) = 0
        [ShowIf(_ShouldMaterialOverrideDissolveAmount, Equal, 1)]
        [Sub(_PerCharacterEffectGroup)]_MaterialOverriddenDissolveAmount("Overridden Dissolve Amount", Range(0,1)) = 1
        */
    ...
    SubShader
    {
        ...
        #pragma shader_feature_local_fragment _BASEMAP_STACKING_LAYER11

        #pragma shader_feature_local_fragment _BASEMAP_STACKING_LAYER_SKINCOLOR
        #pragma shader_feature_local_fragment _BASEMAP_STACKING_LAYER_EYEMAKEUP
        #pragma shader_feature_local_fragment _BASEMAP_STACKING_LAYER_CHEEKMAKEUP
        #pragma shader_feature_local_fragment _BASEMAP_STACKING_LAYER_LIPMAKEUP
        #pragma shader_feature_local_fragment _BASEMAP_STACKING_LAYER_BEAUTYSPOT
        ...
        // per material effect
        #pragma shader_feature_local _PER_MAT_DISSOLVE_ON
