...
- NiloToonVolumePresetPicker: +032 volume, a volume extract from NiloToon's Unity6 concert demo
- NiloToon all in one renderer feature: + forceRenderPrepassBuffer toggle

### Fixed
- greatly optimize CPU drawing performance, when no character use ColorFill and ExtraThickOutline 
- fix ToonOutlinePass_RightAfterTransparent draw order bug (before: BeforeRenderingTransparents+1, now: AfterRenderingTransparents)
----------------------------------------------
## [0.17.7] - 2025-10-06

### Note to user
- DO not use NiloToon 0.17.4 - 0.17.6, these versions have critical bug in NiloToonBloom intensity and format
- You must skip 0.17.4 - 0.17.6, use 0.17.7 or later instead

### Fixed
- Fix a critical NiloToonBloom format bug in ver 0.17.4-0.17.6. Please skip 0.17.4 - 0.17.6, use 0.17.7 or later instead
----------------------------------------------
## [0.17.6] - 2025-10-05

### Note to user
- This version has critical bug in NiloToonBloom intensity and format, use 0.17.7 or later instead

### Fixed
- NiloToonLightSourceModifier: fix revertible buttons cause inspector UI not rendering and spam error
----------------------------------------------
## [0.17.5] - 2025-10-02
...
### Fixed
- fix revertible buttons warning spam
- fix revertible buttons not support enum field
----------------------------------------------
## [0.17.4] - 2025-10-01
...
### Fixed
- NiloToonSetToonParamPass.cs: fix C# compile error for Unity6000.3.0b2 beta
- fix many obsolete warning from compatibility mode's code in Unity6.x, due to the introduction of render graph API
- completely remove all OpenGLES2 code
----------------------------------------------
## [0.17.3] - 2025-09-27

### Breaking change
- (breaking) NiloToonCharacter shader: move face mask sampling logic from vertex shader to fragment shader to improve quality, now face mask area will not be affected the vertices distribution
- (breaking) NiloToonCharacter shader: remove _DepthTexShadowIgnoreLightDir
- (breaking) NiloToonPerCharacterRenderController: now auto setup or AutoRefillRenderers only put meshrenderer & skinnedmeshrendererer into allRenderers list
- (breaking) Self Shadow quality option now supports Unity2021.3

### Added
- NiloToonLightSourceModifier: + ignoreRenderingLayer toggle
- NiloToonLightSourceModifier: + 5 preset buttons
- NiloToonLightSourceModifier: + revert buttons
- NiloToonCharacterMainLightOverrider: + revert buttons
- NiloToonCharacterLightController: + revert buttons
- NiloToonAllInOneRendererFeature: + revert buttons
- now prepass buffer store face area in r channel
- NiloToonCharacter shader: + _DepthTexRimLightMinimumThresholdOffsetForFace
- NiloToonCharacter shader: + _DepthTexRimLightWidthClampForFace
- NiloToonCharacter shader: + _OutlineApplyAutoWidthAdjustment
- NiloToonCharacter shader: + _OutlineZOffsetMaskTexFromVertexColorInvertColor
- NiloToonCharacter shader: + Outline Tint Color Map
- NiloToonCharacter shader: + emission anim ramp map
- NiloToonCharRenderingControlVolume: +skin/face & non-skin/face shadow tint color
- NiloToonShadowControlVolume: +skin/face & non-skin/face shadow tint color

### Changed
- NiloToonPerCharacterRenderController: optmize by caching editor PlayerPrefs.GetInt. 
- NiloToonPerCharacterRenderController: Add profile samples for better profiler display

### Fixed
- Self Shadow now display correctly in Unity6 (sampler bug fixed)
- NiloToonPerCharacterRenderController: fix a bug that "Dissolve" group can't display correctly 
- Depth priming rimlight feature fallback: now correctly apply the fallback to face area only, not affecting other area incorrectly
- Motion blur shader: fix not found error on reimport
- NiloToonEditorShaderStripping: fix null error when build using console command or multiple URP assets
- NiloPrepassBufferPass: fix z reject method zfighting bug (For NiloBllom / NiloTonemapping)
----------------------------------------------
## [0.17.2] - 2025-08-05
...
### Added
- (Big change)All NiloToon passes fully support Render Graph!!!!!!!!!!!! User can enable RenderGraph now and should not see any visual difference.
