...
namespace NiloToon.NiloToonURP
{
    ...
    class NiloToonEditorShaderStripping : IPreprocessShaders
    {
        ...
        private static NiloToonShaderStrippingSettingSO.Settings GetNiloToonStrippingTargetResult()
        {
            ...
            NiloToonShaderStrippingSettingSO perPlatformUserStrippingSetting = NiloToonAllInOneRendererFeature.Instance?.settings?.shaderStrippingSettingSO; // NiloToonAllInOneRendererFeature.Instance is null when build using console command
