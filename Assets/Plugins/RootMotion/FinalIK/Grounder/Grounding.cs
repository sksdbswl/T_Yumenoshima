...
namespace RootMotion.FinalIK {
	...
	public partial class Grounding {
        ...
        /// <summary>
        /// If true, 'overstepFallsDown' only applies when the foot is in front of the body.
        /// </summary>
        [Tooltip("If true, 'overstepFallsDown' only applies when the foot is in front of the body.")]
        public bool frontFootOverstepFallsDown = false;
		/// <summary>
		/// The raycasting quality. Fastest is a single raycast per foot, Simple is three raycasts, Best is one raycast and a capsule cast per foot.
		/// </summary>
